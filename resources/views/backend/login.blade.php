	        ...
	        <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
	            ...
	            <div class="d-flex flex-column-fluid flex-column flex-center">
	                ...
	                <div class="login-form login-signup pt-11">
	                    <!--begin::Form-->
	                    <form class="form" novalidate="novalidate" method="post" action="/admin/register" id="kt_login_signup_form">
							<input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
							<!--begin::Title-->
	                        <div class="text-center pb-8">
	                ...
	                <div class="login-form login-forgot pt-11">
	                    <!--begin::Form-->
	                    <form class="form" novalidate="novalidate" method="post" action="/admin/forgot" id="kt_login_forgot_form">
							<input type="hidden" name="_token" id="csrf-token" value="{{ Session::token() }}" />
	                        <!--begin::Title-->
	                        <div class="text-center pb-8">
...
<script src="/backend/js/login-general.js"></script>
<!--end::Page Scripts-->
