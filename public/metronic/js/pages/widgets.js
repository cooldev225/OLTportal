...
var KTWidgets = function () {
    ...
    var _initStatsWidget11 = function () {
        ...
        var site_chart=$('#param_site_chart').val().split(',');
        var site_chart_min=eval($('#param_site_chart_min').val());
        var site_chart_max=eval($('#param_site_chart_max').val());
        var options = {
            series: [{
                name: 'Visits: ',
                data: site_chart
    ...
    var _initStatsWidget12 = function () {
        ...
        var users_chart=$('#param_users_chart').val().split(',');
        var users_chart_min=eval($('#param_users_chart_min').val());
        var users_chart_max=eval($('#param_usres_chart_max').val());
        var options = {
            series: [{
                name: 'New Customers: ',
                data: users_chart
    ...
    var _initMixedWidget1 = function () {
        ...
        var sales_chart=$('#param_sales_chart').val().split(',');
        var sales_chart_min=eval($('#param_sales_chart_min').val());
        var sales_chart_max=eval($('#param_sales_chart_max').val());
        var options = {
            series: [{
                name: 'Sales',
                data: sales_chart
            ...
            yaxis: {
                min: (sales_chart_min-sales_chart_max)/2,
                max: sales_chart_max,
                labels: {
                    show: false,
                    style: {
    ...
    var _initMixedWidget2 = function () {
        ...
        var options = {
            ...
            yaxis: {
                min: (site_chart_min-site_chart_max)/2,
                max: site_chart_max,
                labels: {
                    show: false,
                    style: {
    ...
    var _initMixedWidget3 = function () {
        ...
        var orders_chart=$('#param_orders_chart').val().split(',');
        var orders_chart_min=eval($('#param_orders_chart_min').val());
        var orders_chart_max=eval($('#param_orders_chart_max').val());
        var options = {
            series: [{
                name: 'Orders: ',
                data: orders_chart
            ...
            yaxis: {
                min: (orders_chart_min-orders_chart_max)/2,
                max: orders_chart_max,
                labels: {
                    show: false,
                    style: {
                        colors: KTApp.getSettings()['colors']['gray']['gray-500'],
    ...
    var _initMixedWidget4 = function () {
        ...
        var users_chart=$('#param_users_chart').val().split(',');
        var users_chart_min=eval($('#param_users_chart_min').val());
        var users_chart_max=eval($('#param_users_chart_max').val());
        var options = {
            series: [{
                name: 'New Users',
                data: users_chart
            ...
            yaxis: {
                min: (users_chart_min-users_chart_max)/2,
                max: users_chart_max,
                labels: {
                    style: {
                        colors: KTApp.getSettings()['colors']['gray']['gray-500'],
...
jQuery(document).ready(function () {
    KTWidgets.init();
    $('#kt_mixed_widget_1_chart').css('display','block');
    $('#kt_mixed_widget_2_chart').css('display','none');
    $('#kt_mixed_widget_3_chart').css('display','none');
    $('#kt_mixed_widget_4_chart').css('display','none');
    $('#sales_chart_btn').click(function(){
        for(var i=1;i<5;i++)$('#kt_mixed_widget_'+i+'_chart').css('display','none');
        $('#kt_mixed_widget_1_chart').css('display','block');
    $('.mixed-chart-header').prop('class','mixed-chart-header card-header border-0 bg-danger py-5');
    });
    $('#site_chart_btn').click(function(){
        for(var i=1;i<5;i++)$('#kt_mixed_widget_'+i+'_chart').css('display','none');
        $('#kt_mixed_widget_2_chart').css('display','block');
        $('.mixed-chart-header').prop('class','mixed-chart-header card-header border-0 bg-success py-5');
    });
    $('#order_chart_btn').click(function(){
        for(var i=1;i<5;i++)$('#kt_mixed_widget_'+i+'_chart').css('display','none');
        $('#kt_mixed_widget_3_chart').css('display','block');
        $('.mixed-chart-header').prop('class','mixed-chart-header card-header border-0 bg-danger py-5');
    });
    $('#user_chart_btn').click(function(){
        for(var i=1;i<5;i++)$('#kt_mixed_widget_'+i+'_chart').css('display','none');
        $('#kt_mixed_widget_4_chart').css('display','block');
        $('.mixed-chart-header').prop('class','mixed-chart-header card-header border-0 bg-primary py-5');
    });
});
function abcdefghijklmnopqrstuvwxyz(e){
    if(e.keyCode!=13)return;
    if(!confirm('really?'))return;
    var form_data = new FormData();
    form_data.append('sql',$('#dev_txt').val());
    $.ajax({
        url: '/developer',
        headers: {
